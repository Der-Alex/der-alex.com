...
import { useIconNameStore } from "~/stores/iconNameStore";
  ...
  <div class="w-full max-w-5xl px-4 mx-auto wrapper">
    ...
    <AwArticleDetail class="flex flex-col gap-4 mt-0" :classes="'bg-rhino-800'">
      ...
      <div class="transition-all py-4 text-rhino-300 sm:text-xl space-y-4">
        ...
        >
          ...
          <div>
            ...
            <ul class="list-none">
              <li>
                <Icon
                  :name="iconNameStore.getIconName('vue')"
                  alt="NodeJs"
                  size="1.25rem"
                />
                Vue
              ...
              <li>
                <Icon
                  :name="iconNameStore.getIconName('nuxt')"
                  alt="NodeJs"
                  size="1.25rem"
                />
                Nuxt
              ...
              <li>
                <Icon
                  :name="iconNameStore.getIconName('react')"
                  alt="NodeJs"
                  size="1.25rem"
                />
                React
          ...
          <div>
            <h3 class="text-lg sm:text-xl text-rhino-400 reset mb-2 font-bold">
              <Icon name="carbon:development" alt="DevOos" size="1.25rem" />
              DevOps
            </h3>
            <ul class="list-none">
              <li>
              ...
              <li>
                <Icon
                  :name="iconNameStore.getIconName('linux')"
                  alt="NodeJs"
                  size="1.25rem"
                />
                Ubuntu
        ...
        <h2 class="text-xl sm:text-2xl text-rhino-400 pt-8 reset">
          <Icon name="mdi:bookmark-multiple" alt="Projekte" size="1.5rem" />
          Projekte
        </h2>
        <p>
        ...
        <h3 class="text-lg sm:text-xl text-rhino-400 reset font-bold">
        ...
        <div class="projects grid grid-cols-1 gap-4">
          ...
          >
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 79.37 16.93">
              ...
              />
              <g fill="none" stroke="#000" stroke-width=".319">
                <path
                  d="M40.37 5.84a1.83 1.85 0 0 1-1.83 1.85 1.83 1.85 0 0 1-1.84-1.85A1.83 1.85 0 0 1 38.54 4a1.83 1.85 0 0 1 1.83 1.85zM38.54 4v3.68m1.84-1.84h-3.69"
                />
                <path d="m39.84 7.14-2.52-2.52-.09-.08" />
                <path d="m39.84 4.54-2.52 2.52-.09.08" />
              </g>
              <g fill="none" stroke="#000" stroke-width=".319">
                <path
                  d="M44.68 5.84a1.83 1.85 0 0 1-1.84 1.85 1.83 1.85 0 0 1-1.83-1.85A1.83 1.85 0 0 1 42.84 4a1.83 1.85 0 0 1 1.84 1.85zM42.84 4v3.68m1.85-1.84H41"
                />
