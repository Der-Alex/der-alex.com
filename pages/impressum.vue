<template>
  <div class="max-w-5xl px-4 mx-auto wrapper">
    ...
    <AwArticleDetail class="flex flex-col gap-4 text-rhino-100">
      ...
      <p><strong>Internetseite: &nbsp;</strong>https://www.der-alex.com</p>
      ...
      <p>
        Verantwortliche für den Inhalt ist gemäß § 55 Abs. 2
      ...
      <p>
        ...
        Internetseite keine Gewähr für die Aktualität, Vollständigkeit und
        Richtigkeit der bereitgestellten Seiten und Inhalte.
      </p>
      <p>
        Als Diensteanbieter ist der Anbieter dieser Internetseite gemäß § 7 Abs.
        1 TMG für eigene Inhalte und bereitgestellte Informationen auf diesen
      ...
      <p>
        Die Internetseite enthält sog. „externe Links“ (Verlinkungen) zu anderen
        Webseiten, auf deren Inhalt der Anbieter der Internetseite keinen
        Einfluss hat. Aus diesem Grund kann der Anbieter für diese Inhalte auch
        keine Gewähr übernehmen. Für die Inhalte und Richtigkeit der
        bereitgestellten Informationen ist der jeweilige Anbieter der verlinkten
        Internetseite verantwortlich. Zum Zeitpunkt der Verlinkung waren keine
        Rechtsverstöße erkennbar. Bei Bekanntwerden einer solchen
        Rechtsverletzung wird der Link umgehend entfernt.
      </p>
      <p><strong> Urheberrecht / Leistungsschutzrecht</strong></p>
      <p>
        Die auf dieser Internetseite veröffentlichten Inhalte, Werke und
        ...
        bereitgestellten Informationen auf diesen Internetseiten ist nicht
